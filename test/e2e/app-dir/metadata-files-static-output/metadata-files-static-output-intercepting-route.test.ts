    ...
    expect(await getMetadataHeadTags(browser)).toMatchInlineSnapshot(`
     {
       ...
       "metas": [
         ...
         {
           "content": "http://localhost:$PORT/intercepting/(..)intercept-me/twitter-image.png?603d046c9a6fdfbb",
           "name": "twitter:image",
         },
         {
         ...
         {
           "content": "http://localhost:$PORT/intercepting/(..)intercept-me/opengraph-image.png?603d046c9a6fdfbb",
           "property": "og:image",
         },
         {
           "content": "About Next.js",
